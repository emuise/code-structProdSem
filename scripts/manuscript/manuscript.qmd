...
structural attributes range from an RMSE of 29.7% (structural
...
sample units were selected from each stratum; in the strata where this
was not achieved, all sampling units meeting the above restrictions were
selected. Sampling was conducted in R version 4.2.2 [@R-base] using the
**sgsR** package [@R-sgsR]. Neighbourhood analyses for the land cover
