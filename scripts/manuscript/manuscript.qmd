...
the structure and function of ecosystems and proposes a method to
examine potential overlap when generating remote sensing EBV's.
...
### Partial Redundancy Analysis and Variation Partitioning

Partial redundancy analysis and variation partitioning was used to
relate the primary and modeled forest structure variables to ecosystem
...
reported. We use ANOVAs to test which canonical axes are significant,
and eigenvalues to determine the proprotion of variance explained by
each axis.
